...
with tab1:
  ...
  st.text('Pada tahun 2013, penurunan kualitas udara di Beijing pernah mencapai \"Red Alert\" sebuah kondisi polusi serius dalam 3 hari berturut-turut, yang akhirnya memicu pemerintah untuk mengambil \"Heavy Air Pollution Contingency Plan\".')
  st.text('Proyek analisis data kali ini, akan mengevaluasi keberhasilan \"5-year-action-plan\" pemerintah Munisipalitas Beijing, serta keperluan peringatan dini berdasarkan kondisi cuaca tertentu')
